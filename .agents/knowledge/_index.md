...
| [firefox](firefox.md) | Browser padrão + PWAs nativos (firefoxpwa) no lugar do Chrome `--app` | `modules/home/firefox.nix`, `config/hypr/hyprland/scripts/launch-pwa.sh`, `config/hypr/hyprland/keybinds.lua` |
