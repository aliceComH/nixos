...
hl.bind("ALT + R", hl.dsp.exec_cmd("librewolf"))
hl.bind("ALT + C", hl.dsp.exec_cmd("cursor"))
...
hl.bind("ALT + 2", hl.dsp.exec_cmd("bash ~/.config/hypr/hyprland/scripts/launch-pwa.sh https://web.whatsapp.com/ WhatsApp"))
hl.bind("ALT + 3", hl.dsp.exec_cmd("steam"))
hl.bind("ALT + 4", hl.dsp.exec_cmd("bash ~/.config/hypr/hyprland/scripts/launch-pwa.sh https://web.stremio.com/ Stremio"))
hl.bind("ALT + 5", hl.dsp.exec_cmd("cd ~/Projetos/jarvis && nix-shell --run \"GTK_THEME=Adwaita:dark python jarvis.py\""))
hl.bind("ALT + 6", hl.dsp.exec_cmd("bash ~/.config/hypr/hyprland/scripts/launch-pwa.sh https://music.youtube.com/ 'YouTube Music'"))
...
hl.bind("SUPER + F7", hl.dsp.focus({ workspace = "7" }))
...
hl.define_submap("media", function() -- MEDIA (Workspace 7)
    hl.bind("F6", hl.dsp.focus({ workspace = "5" }))
    hl.bind("ALT + F6", hl.dsp.window.move({ workspace = "5", follow = false }))

    hl.bind("F7", hl.dsp.exec_cmd("bash ~/.config/hypr/hyprland/scripts/workspace_previous_filtered.sh"))
