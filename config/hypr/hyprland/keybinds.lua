...
hl.bind("ALT + 2", hl.dsp.exec_cmd("google-chrome-stable --app=\"https://web.whatsapp.com/\""))
hl.bind("ALT + 3", hl.dsp.exec_cmd("google-chrome-stable --app=\"https://music.youtube.com/\""))
hl.bind("ALT + 4", hl.dsp.exec_cmd("google-chrome-stable --app=\"https://web.stremio.com/\""))
hl.bind("ALT + 5", hl.dsp.exec_cmd("steam"))
hl.bind("ALT + 6", hl.dsp.exec_cmd("GTK_THEME=Adwaita:dark python ~/Projetos/claudia/claudia.py"))
